...
public class BankApp {
	...
	public static void main(String[] args) {
		...
		Account acc2 = new Account(1002, 1500);//boyle tanimlandiginda erisilebilir
		customer.addAccount(acc2);
		
		/*
		customer.addAccount(new Account(1001,1500));//bir degisken atanmadigi icin adrese erisilemez 
